...
<body>
	...
	<div class="container margintop">
		<h1 class="text-center lightgreen mb-3">Kosár tartalma</h1>
		<p style="color: red; font-weight: bold">${emptycart}</p>
		<c:forEach var="product" items="${productsList}">
			<div class="card bg-dark">
				<div class="card-body">
					<img class="mr-3" src="img/${product.image}" style="float:left;" alt="product" width="100" height="100">
					<p class="card-title my-0">${product.name}</p>
					<p class="my-0">${product.price}Ft</p>	<a href="/deletefromcart/${product.id}"><i style="color:#86C232; float:right;" class="material-icons">delete</i></a>
					<p>Mennyiség: <input type="number" name="amount" value="1"></p>
				</div>
			</div>
			<br>
		</c:forEach>
	...
	<h4 class="text-center my-3"><a href="/products" class="linkgreen">Vissza a termékekhez</a></h4>

	<div class="container">
		<h3 class="mt-4 mb-0 lightgreen">SZÁLLÍTÁSI ADATOK</h3>
		<p class="mt-0 mb-3"><a href="/profile" >(módosítás)</a></p>
		<p>Teljes név:  ${name}</p>
		<hr>
		<p>Cím:  ${address}</p>
		<hr>
		...
		<a href="/ordered" class="text-center"><button class="btn my-3">MEGRENDELEM</button></a>
	</div>
